    ...
    extraConfig = lib.mkMerge [
      {
        ...
        difftool = {
          prompt = false;
          ediff.cmd = "${ediff-tool}/bin/ediff-tool $LOCAL $REMOTE";
          vscode.cmd = "code --wait --diff $LOCAL $REMOTE";
        };

        mergetool = {
          prompt = false;
          ediff.cmd = "${ediff-tool}/bin/ediff-tool $LOCAL $REMOTE $MERGED";
